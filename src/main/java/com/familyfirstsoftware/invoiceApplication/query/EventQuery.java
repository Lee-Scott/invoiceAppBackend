package com.familyfirstsoftware.invoiceApplication.query;
...
public class EventQuery {
    ...
    // TODO - this query needs testing, it is not used
    ...
    public static final String INSERT_EVENT_REPORT_QUERY = "INSERT INTO UserEvents (user_id, event_id, device, ip_address) VALUES (:userId, (SELECT id FROM Events WHERE type = :type), :device, :ipAddress)";
}
