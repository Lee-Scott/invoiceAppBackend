...
import com.familyfirstsoftware.invoiceApplication.rowMapper.RoleRowMapper;
...
import static com.familyfirstsoftware.invoiceApplication.query.RoleQuery.*;
...
public class RoleRepositoryImpl implements RoleRepository<Role> {
    ...
    public Collection<Role> list() {
        log.info("Fetching all roles in the db");
        try {
    ...
    public Role getRoleByUserId(Long userId) {
        ...
        try {
            ...
            System.out.println("---- No role found by id: " + userId);
            throw new ApiException("No role found by name: " + ROLE_USER.name());
        } catch (Exception exception) {
            log.error(exception.getMessage());
            throw new ApiException("An error occurred. Please try again.");
