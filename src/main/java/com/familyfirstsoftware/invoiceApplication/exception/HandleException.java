package com.familyfirstsoftware.invoiceApplication.exception;
...
public class HandleException extends ResponseEntityExceptionHandler implements ErrorController {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception exception, Object body, HttpHeaders headers, HttpStatusCode statusCode, WebRequest request) {
        log.error("HandleException.handleExceptionInternal: " + exception.getMessage());
    ...
    public ResponseEntity<HttpResponse> badCredentialsException(BadCredentialsException exception) {
        log.error("HandleException.badCredentialsException: " + exception.getMessage());
        return new ResponseEntity<>(
                HttpResponse.builder()
                        .timeStamp(now().toString())
    ...
    public ResponseEntity<HttpResponse> apiException(ApiException exception) {
        log.error("HandleException.apiException: " + exception.getMessage());
        return new ResponseEntity<>(
                HttpResponse.builder()
                        .timeStamp(now().toString())
                        .reason(exception.getMessage())
    ...
    public ResponseEntity<HttpResponse> accessDeniedException(AccessDeniedException exception) {
        log.error("HandleException.accessDeniedException: " + exception.getMessage());
        return new ResponseEntity<>(
                HttpResponse.builder()
                        .timeStamp(now().toString())
    ...
    public ResponseEntity<HttpResponse> emptyResultDataAccessException(EmptyResultDataAccessException exception) {
        log.error("HandleException.emptyResultDataAccessException: " + exception.getMessage());
        return new ResponseEntity<>(
                HttpResponse.builder()
                        .timeStamp(now().toString())
    ...
    public ResponseEntity<HttpResponse> disabledException(DisabledException exception) {
        log.error("HandleException.disabledException: " + exception.getMessage());
        return new ResponseEntity<>(
                HttpResponse.builder()
                        .timeStamp(now().toString())
                        .developerMessage(exception.getMessage())
    ...
    public ResponseEntity<HttpResponse> lockedException(LockedException exception) {
        log.error("HandleException.lockedException: " + exception.getMessage());
        return new ResponseEntity<>(
                HttpResponse.builder()
                        .timeStamp(now().toString())
                        .developerMessage(exception.getMessage())
    ...
    public ResponseEntity<HttpResponse> dataAccessException(DataAccessException exception) {
        log.error("HandleException.dataAccessException: " + exception.getMessage());
        return new ResponseEntity<>(
                HttpResponse.builder()
                        .timeStamp(now().toString())
